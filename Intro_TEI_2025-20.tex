...
% ]{Adobe Garamond Pro}
% 
\usepackage[MainFeatures={medium,
  Ligatures=Common,
  Numbers=OldStyle,
  SmallCapsFeatures = {LetterSpace=5.0}}]
{junicodevf}
...
\usepackage[medium]{junicode}
% \usepackage[oldstylenums, nott]{kpfonts}
% \usepackage[osf]{fbb}  % Bembo-Cardo
% \usepackage[osf]{ETbb} % Tufte's Bembo
...
% \usepackage[scaled=0.9]{cascadia-code}
...
% Para la opción allowframebreaks: -------------
...
\newcommand*{\azulit}[1]{\textit{\textcolor[HTML]{14145A}{#1}}}
\newcommand*{\azul}[1]{\textcolor[HTML]{14145A}{#1}}
\newcommand{\Verde}{\color{DarkGreen}}
\newcommand*{\verde}[1]{\textcolor{DarkGreen}{#1}}
\newcommand{\Amarillo}{\color{Goldenrod}}
\newcommand*{\amarillo}[1]{\textcolor{Goldenrod}{#1}}
\newcommand{\Morado}{\color{DarkOrchid}}
\newcommand*{\morado}[1]{\textcolor{DarkOrchid}{#1}}
\newcommand{\Naranja}{\color{DarkOrange}}
\newcommand*{\naranja}[1]{\textcolor{DarkOrange}{#1}}
% -----------------------------------------------
...
\usepackage{minted}
\setminted{fontfamily=tt, fontsize=\scriptsize}
